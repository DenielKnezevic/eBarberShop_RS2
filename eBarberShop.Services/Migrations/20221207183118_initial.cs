    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Uslugas", x => x.UslugaID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DatumKreiranja = table.Column<DateTime>(type: "datetime2", nullable: false),
                    VrijemeTermina = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    KorisnikID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Rezervacijas_Termins_TerminID",
                        column: x => x.TerminID,
                        principalTable: "Termins",
                        principalColumn: "TerminID");
                    table.ForeignKey(
                        name: "FK_Rezervacijas_Uslugas_UslugaID",
                        column: x => x.UslugaID,
                        principalTable: "Uslugas",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rezervacijas_TerminID",
                table: "Rezervacijas",
                column: "TerminID");

            migrationBuilder.CreateIndex(
                name: "IX_Rezervacijas_UslugaID",
                table: "Rezervacijas",
                column: "UslugaID");
